...
# elemz = soup.find_all('div div div span', attrs={'class="dre-section-labelsecondary dre-section-labelsecondary--prefixed" style="color:#4d4d4d"'})
# print(elemz)
elems = soup.select('div div div span')
